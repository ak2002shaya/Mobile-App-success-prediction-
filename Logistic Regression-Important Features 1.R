...
# Plot ROC curve
plot(roc_curve, main = "LR-OverSampled Data-ROC Curve(Important Features)", col = "blue", lwd = 2)
...
# Plot ROC curve
plot(roc_curve, main = "LR-UnderSampled Data-ROC Curve(Important Features)", col = "blue", lwd = 2)
